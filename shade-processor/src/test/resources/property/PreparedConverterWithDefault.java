...
public abstract class PreparedConverterWithDefault {
    @Property(key = "published", defValue = "1512961200000", converter = DateConverter.class)
    public abstract Date published();

    @Property(key = "website", defValue = "https://github.com", converter = UriConverter.class)
